...
const NAV_ITEMS = [
  ...
  { href: "/admin/shop-requests", label: "店舗リクエスト", icon: MessageSquarePlus },
  { href: "/admin/analytics", label: "分析ダッシュボード", icon: BarChart3 },
  { href: "/admin/operations", label: "運用管理", icon: Settings },
